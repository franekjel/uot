...
Server::Server() : players(), messaging_service(), game_in_progress(false)
{
    ...
    messaging_service.set_handle_actions_callback([&](std::shared_ptr<messageTypes::ActionsPayload> actions)
...
void Server::handle_actions(std::shared_ptr<messageTypes::ActionsPayload> actions)
{
    if (game_in_progress)
    {
        // TODO
