...
const std::map<ModuleType, Module> Modules{
    ...
    {ModuleType::BasicShieldGenerator,
     Module::ContructionModule(Module("Basic shield generator", 1, 1.5f,
                                      {{Resource::Metals, 5.0f}, {Resource::Crystals, 3.0f}}, {}, Module::Inside),
                               100.0f)},
    {ModuleType::ImprovedShieldGenerator,
     Module::ContructionModule(Module("Improved shield generator", 1, 3.0f,
    ...
    {ModuleType::MetalArmorPlates,
     Module::ContructionModule(Module("Metal armor plates", 2, 0.0f, {{Resource::Metals, 15.0f}}, {}, Module::Sides),
                               100.0f)},
    {ModuleType::ImprovedArmorPlates,
     Module::ContructionModule(Module("Armor plates enchanced with rare metals", 2, 0.0f,
                                      {{Resource::Metals, 15.0f}, {Resource::RareMetals, 10.0f}}, {}, Module::Sides),
                               200.0f)},
    {ModuleType::AdvancedArmorPlates, Module::ContructionModule(Module("Advanced armor plates", 2, 0.0f,
    ...
    {ModuleType::Quarters,
     Module::ContructionModule(Module("Quarters", 2, 1.0f, {{Resource::Metals, 25.0f}}, {}, Module::Inside), 5.0f)},
